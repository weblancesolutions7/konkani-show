                ...
                {loading ? (
                    <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-6">
                        {Array.from({ length: 10 }).map((_, i) => (
                            <div key={i} className="aspect-square rounded-2xl bg-surface-200 animate-pulse" />
                        ))}
                    </div>
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-6">
                        {preferences.categories.map((cat) => (
                            <Link
                                ...
                                className="group relative aspect-square rounded-2xl bg-white border border-surface-200 p-8 flex flex-col items-center justify-center text-center transition-all hover:shadow-premium hover:border-primary/30"
                            >
