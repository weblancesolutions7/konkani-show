                ...
                <div className="space-y-3 animate-in fade-in slide-in-from-top-1 duration-200">
                    <div className="space-y-1">
                        ...
                        <input 
                            ...
                            className="w-full px-4 py-2 rounded-xl border border-surface-200 text-sm focus:ring-1 focus:ring-primary focus:border-primary outline-none transition-all"
                        />
                    </div>
                    <div className="space-y-1">
...
const FilterAccordion: React.FC<{ 
  ...
  <div className="bg-white rounded-2xl border border-surface-200 shadow-sm overflow-hidden transition-all duration-300">
    <button 
      onClick={onToggle}
