                            ...
                            <tr key={event.id} className="hover:bg-surface-50/50 transition-colors">
                                <td className="p-4">
                                    <div className="flex items-center gap-4">
                                        <div className="w-12 h-12  bg-surface-200 overflow-hidden flex-shrink-0">
                                ...
                                <td className="p-4">
                                    <div className="flex gap-2">
                                        {onApprove && event.status === 'PENDING' && (
                                            <button onClick={() => onApprove(event.id)} className="p-2 bg-emerald-100 text-emerald-700  hover:bg-emerald-200 transition-colors text-xs font-bold">Approve</button>
                                        )}
                                        ...
                                        {onDelete && event.status !== 'DELETED' && (
                                            <button onClick={() => onDelete(event.id)} className="p-2 bg-rose-100 text-rose-700  hover:bg-rose-200 transition-colors text-xs font-bold">Delete</button>
                                        )}
                                    </div>
                                </td>
                            </tr>
